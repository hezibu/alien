...
#include "stanExports_modified_belmaker_et_al_2009_model.h"

RCPP_MODULE(stan_fit4modified_belmaker_et_al_2009_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_modified_belmaker_et_al_2009_model")
